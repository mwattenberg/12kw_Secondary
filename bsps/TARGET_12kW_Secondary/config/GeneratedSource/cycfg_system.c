...
#if  (CY_CPU_CORTEX_M33) && defined(CY_PDL_TZ_ENABLED)
#define CY_CFG_SYSCLK_CLKALTSYSTICK_ENABLED 1
#define CY_CFG_SYSCLK_CLKALTSYSTICK_SOURCE CY_SYSTICK_CLOCK_SOURCE_CLK_IMO
#define CY_CFG_SYSCLK_CLKALTSYSTICK_INTERVAL 50
#define CY_CFG_SYSCLK_CLKALTSYSTICK_FREQUENCY 8000000
#define CY_CFG_SYSCLK_CLKALTSYSTICK_TICKS ((uint32_t)(((50)/1000000.0)*8000000))
#endif /*  (CY_CPU_CORTEX_M33) && defined(CY_PDL_TZ_ENABLED) */
...
#define CY_CFG_SYSCLK_CLKHF2_FREQ_MHZ 180UL
...
#define CY_CFG_SYSCLK_CLKHF3_FREQ_MHZ 180UL
