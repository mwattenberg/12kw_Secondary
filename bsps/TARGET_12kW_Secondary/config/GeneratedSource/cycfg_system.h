...
#define CY_CFG_PWR_MODE_MF 0x05UL
#define CY_CFG_PWR_MODE_OD 0x06UL
...
#define CY_CFG_PWR_SYS_ACTIVE_MODE CY_CFG_PWR_MODE_OD
#define CY_CFG_PWR_SYS_ACTIVE_PROFILE CY_CFG_PWR_MODE_OD
