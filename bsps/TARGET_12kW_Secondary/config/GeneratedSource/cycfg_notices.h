...
#if !defined(PSC3M5FDS2LGQ1)
#error "Unexpected MPN; expected DEVICE:=PSC3M5FDS2LGQ1. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(PSC3M5FDS2LGQ1) */
